...
import solutions.pack3.MyLinkedListTricky;
...
public class Lab4b_TrickyLinkedList {
    ...
    static void q1() {
        ...
        mList.q1_rotate_counterclockwise(1);
        System.out.println("(k = " + 1 + ")  -> " + mList);
        mList.q1_rotate_counterclockwise(3);
        System.out.println("(k = " + 3 + ")  -> " +mList);
        mList.q1_rotate_counterclockwise(7);
