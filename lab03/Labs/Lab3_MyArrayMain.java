package Labs;
import solutions.code3.MyArrayBasic;
import solutions.code3.MyArray_661123; 
...
public class Lab3_MyArrayMain {
    ...
    static private void myArray_demo4() {
        MyArray_661123 demo = new MyArray_661123(5);
    ...
    static private void task2() {
        ...
        for (int N = initial; N <= 10 * initial; N += step) {
            ...
            MyArray_661123 mArray = new MyArray_661123(N);
            for (int n = 1; n <N; n++)
        ...
        for (int N = initial; N <= 10 * initial; N += step) {
            long start = System.currentTimeMillis();
            MyArray_661123 mArray = new MyArray_661123();
            for (int n = 1; n <N; n++)
                mArray.add((int)(Math.random()*1000));
            long time = (System.currentTimeMillis() - start);
            System.out.println(N + "\t\t" + time);
